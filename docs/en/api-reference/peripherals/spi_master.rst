...
.. include:: /../_static/diagrams/spi_master/miso_timing_waveform.rst
...
frequency (in MHz) host can read (or read and write) under different conditions is as below:
...
.. include:: /../_static/diagrams/spi_master/miso_timing_waveform_async.rst
...
Corresponding frequency limit for different devices with different *input delay* (in ns) are shown in the following 
table:

+--------+--------------+-----------------+-------------------+
| Master | Input delay  | MISO path delay | Freq. limit (MHz) |
+========+==============+=================+===================+
| IOMUX  | 0            | 0               | 80                |
+ (0ns)  +--------------+-----------------+-------------------+
|        | 50           | 50              | 16                |
